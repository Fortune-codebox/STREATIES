...
const ProductDetails = () => {
    ...
    }, [dispatch, alert, error, reviewError, prodId, success])

    const addToCart = () => {
        dispatch(addItemToCart(prodId, quantity));
        alert.success('Item Added to Cart')
    }

    const increaseQty = () => {
        const count = document.querySelector('.count')
        console.log('count: ', count.valueAsNumber)
        ...
        {loading ?  <Loader /> : (
            <Fragment>
                    ...
                    <div className="col-12 col-lg-5 mt-5">
                        ...
                        <p>SubCategory: {product.subCategory && product.subCategory.name}</p>
